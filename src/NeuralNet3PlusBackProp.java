...
public class NeuralNet3PlusBackProp
{
      /**
       ...
       */
      public NeuralNet3PlusBackProp(int input, int[] hiddenLayer, int output)
      {
         gradient = true;
         testingAll = false;
      ...
      */
      ...
      {
         Scanner user = new Scanner(System.in);
         System.out.println("Enter 'File' to read a tester file. Otherwise, type 'type.'");
         if (user.next().toLowerCase().equals("file"))
         {
            NeuralNet3PlusBackProp neuro = new NeuralNet3PlusBackProp();
         ...
         else
         {
            ...
            NeuralNet3PlusBackProp neuro = new NeuralNet3PlusBackProp(inputLayers, hiddenLayer, outputLayers); //Sets inputs
            // inside
            // constructor.
            neuro.testGradientDescent();
         } //Testing with typing into the console.
